...
public class PlayFair {
    ...
    static public String format(String old_text)
    {
        int i = 0;
        int len = 0;
   ...
   static public String[] Divid2Pairs(String new_string)
    {
    ...
    static public int[] GetDiminsions(char letter)
    {
        int[] key = new int[2];
        if (letter == 'j')
            letter = 'i';
        ...
        static public String encryptMessage(String Source)
    {
     ...
     static public String decryptMessage(String Code)
    {
